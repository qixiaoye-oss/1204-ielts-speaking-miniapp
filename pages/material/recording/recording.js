...
Page({
  ...
  onLoad(options) {
    ...
    recorderManager.onError((res) => {
      ...
      api.recorderErr("四分块", res.errMsg)
    })
  },
  onUnload() {
  ...
  // ===========数据获取 Start===========
  getData(isPull) {
    api.request(this, '/material/v2/practice/list', {
      // api.request(this, '/material/listPracticeData', {
  ...
  saveData(fileUrl) {
    ...
    audioUtil.batchUploadReading(fileUrl, '/practice/', this).then(res => {
      api.request(this, '/material/savePracticeData', {
        userId: api.getUserId(),
        ...this.options,
